...
from dust3r.datasets.cotracker_kubric import CotrackerKubricDUSt3R as DUSt3R_CotrackerKubricDUSt3R # noqa
from dust3r.datasets.cotracker_kubric_w_vis import CotrackerKubricVISDUSt3R as DUSt3R_CotrackerKubricVISDUSt3R # noqa
from dust3r.datasets.dynamic_replica import DynamicReplicaDUSt3R as DUSt3R_DynamicReplicaDUSt3R # noqa
from dust3r.datasets.dynamic_replica_w_vis import DynamicReplicaVISDUSt3R as DUSt3R_DynamicReplicaVISDUSt3R # noqa
...
class PointOdysseyDUSt3R(DUSt3R_PointOdysseyDUSt3R, MASt3RBaseStereoViewDataset):
    def __init__(self, *args, split, ROOT, **kwargs):
        ...
        #self.is_metric_scale = False
        self.is_metric_scale = False
        print(f"PO METRIC = {self.is_metric_scale=}")


class CotrackerKubricDUSt3R(DUSt3R_CotrackerKubricDUSt3R, MASt3RBaseStereoViewDataset):
    def __init__(self, *args, split, ROOT, **kwargs):
        super().__init__(*args, split=split, ROOT=ROOT, **kwargs)
        self.is_metric_scale = True
        print(f"KUBRIC METRIC = {self.is_metric_scale=}")


class CotrackerKubricVISDUSt3R(DUSt3R_CotrackerKubricVISDUSt3R, MASt3RBaseStereoViewDataset):
    def __init__(self, *args, split, ROOT, **kwargs):
        super().__init__(*args, split=split, ROOT=ROOT, **kwargs)
        self.is_metric_scale = True
        print(f"KUBRIC METRIC = {self.is_metric_scale=}")
...
class DynamicReplicaDUSt3R(DUSt3R_DynamicReplicaDUSt3R,  MASt3RBaseStereoViewDataset):
    def __init__(self, *args, split, ROOT, **kwargs):
        super().__init__(*args, split=split, ROOT=ROOT, **kwargs)
        self.is_metric_scale = True
        print(f"DR METRIC = {self.is_metric_scale=}")

class DynamicReplicaVISDUSt3R(DUSt3R_DynamicReplicaVISDUSt3R,  MASt3RBaseStereoViewDataset):
    def __init__(self, *args, split, ROOT, **kwargs):
        super().__init__(*args, split=split, ROOT=ROOT, **kwargs)
        self.is_metric_scale = True
        print(f"DR METRIC = {self.is_metric_scale=}")
