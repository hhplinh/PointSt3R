...
class CotrackerKubricDUSt3R(BaseStereoViewDataset):
    #def __init__(self,
    ...
    def __init__(
        ...
        #print(self.rgb_paths[:4])
        #print(self.depth_paths[:4])
        #print(self.annotation_paths[:4])
        #print(self.full_idxs[:4])
        #output = {
        ...
        #}
        #with open(f"/root/mast3r_train_subsets/small_train_Kubric_5k.json", "w") as f:
        #    json.dump(output, f)
        #sys.exit(0)
